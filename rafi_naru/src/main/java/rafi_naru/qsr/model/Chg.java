...
public class Chg {
	...
	public String toStringDataUser() {
		return this.date + Constant.OUTPUT_DELIMITER + this.lacci + Constant.OUTPUT_DELIMITER + this.revenue
				+ Constant.OUTPUT_DELIMITER + this.AParty + Constant.OUTPUT_DELIMITER + this.Servicefilter
				+ Constant.OUTPUT_DELIMITER + this.VAScode;
	}
