...
public class Chg {
	...
	public Chg(String date, String lacci, String revenue) {
		super();
		this.date = date;
		this.lacci = lacci;
	...
	public Chg(String timestamp, String aParty, String locationNumberTypeA, String locationNumberA, String bParty,
			String locationNumberTypeB, String locationNumberB, String nrOfReroutings, String iMSI,
			String nrOfNetworkReroutings, String redirectingPartyID, String preCallDuration, String callDuration,
			String chargingID, String roamingFlag, String vLRNumber, String cellID, String negotiatedQoS,
			String requestedQoS, String subscribedQoS, String dialledAPN, String eventType, String providerID,
			String currency, String subscriberstatus, String forwardingflag, String firstcallflag, String cAMELRoaming,
			String timezone, String accountBalance, String accountDelta, String accountNumber, String accountOwner,
			String eventSource, String guidingresourcetype, String roundedduration, String totalvolume,
			String roundedtotalvolume, String eventstartperiod, String chargeincludingfreeallowance,
			String discountamount, String freetotalvolume, String freeduration, String calldirection,
			String chargecodedescription, String specialnumberind, String bonusinformation, String internalCause,
			String basicCause, String timeband, String calltype, String bonusconsumed, String vAScode,
			String servicefilter, String nationalcallingzone, String nationalcalledzone,
			String internationalcallingzone, String internationalcalledzone, String creditindicator, String eventID,
			String accesscode, String countryname, String cPname, String contentid, String ratingGroup,
			String bFTIndicator, String unappliedamount, String partitionID, String ratedDateTime, String area,
			String costband, String ratingOfferId, String settlementIndicator, String tapCode, String mCCMNC,
			String ratingPricingitemID, String fileIdentifier, String recordNumber, String futureString1,
			String futureString2, String futureString3, String allowanceconsumedrevenue,
			String iFRSIndforAllowancerevenue, String iFRSIndforVASevent, String itemizedBillFee,
			String consumedMonetaryAllowance, String partialchargeind) {
		super();
		Timestamp = timestamp;
		AParty = aParty;
