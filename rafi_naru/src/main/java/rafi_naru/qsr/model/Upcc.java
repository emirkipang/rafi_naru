...
public class Upcc {
	...
	public Upcc(String date, String lacci_or_eci, String AccessType, String quotaUsage) {
	...
	public Upcc(String triggerType, String time, String subscriberIdentifier, String iMSI, String mSISDN, String iMEI,
			String paidType, String category, String homeServiceZone, String visitServiceZone, String cGI, String sAI,
			String rAI, String sGSNAddress, String mCCMNC, String roamingStatus, String roamingRegion,
			String accessType, String iPCanType, String uEIP, String aPN, String downloadBandwidth,
			String uploadBandwidth, String servicePackageName, String serviceName, String ruleName, String quotaName,
			String quotaStatus, String quotaConsumption, String quotaBalance, String quotaRecharge, String quotaUsage,
			String quotaNextResetTime, String accountName, String accountStatus, String accountPrivilege,
			String personalValue, String accountBalance, String accountConsumption, String accountUsage,
			String pCRFIPAddress, String accountNextResetTime, String uEIPv6, String aNGWAddress,
			String accessNodeStatus, String tAI, String eCGI, String underControl, String oldQuotaStatus,
			String oldQuotaConsumption, String oldQuotaBalance, String quotaResetTime, String oldAccountStatus,
			String oldAccountPrivilege, String oldAccountBalance, String oldAccountConsumption, String accountResetTime,
			String quotaLastResetTime, String roamingRegion2, String roamingRegion3, String roamingRegion4,
			String roamingRegion5, String roamingRegion6, String roamingRegion7, String roamingRegion8,
			String roamingRegion9, String roamingRegion10, String quotaValueOrStatus, String visitServiceZone2,
			String visitServiceZone3, String visitServiceZone4, String visitServiceZone5, String accumulationValue,
			String accumulationBalance, String accumulationConsumption, String accumulationStartTime,
			String accumulationEndTime, String accumulationExpireFlag, String oldAccumulationValue,
			String oldAccumulationBalance, String oldAccumulationConsumption, String oldAccumulationStartTime,
			String oldAccumulationEndTime, String activationTimeValue, String activationStartTime,
			String activationEndTime, String restTimeValue, String pLMNIdentify, String timeZone, String quotaValue,
			String serviceStartDateTime, String serviceEndDateTime, String serviceDescription,
			String serviceCustomerAttribute, String visitServiceZone6, String visitServiceZone7,
			String visitServiceZone8, String visitServiceZone9, String visitServiceZone10, String subscribedDateTime,
			String rARCause, String transinSubscriberID, String transinQuotaName, String transferQuotaValue,
			String transferQuotaStartTime, String transferQuotaEndTime, String notificationIndication,
			String transferQuotaBalance, String transferQuotaConsumption, String transferTimeStamp,
			String oldActivationStartTime, String oldActivationEndTime, String oldRestTimeValue,
			String trans_inServiceName, String trans_inServiceCustomerAttribute, String billingCycleDate,
			String sessionId, String originHost, String originRealm, String destinationHost, String destinationRealm,
			String rxIPV4, String rxIPV6, String lastAccumulateValue, String currentCumulateTimes, String rxMediaType,
			String rxSpecificAction, String syPolicyCounterIdentifier, String syPolicyCounterStatus,
			String syPendingPolicyCounterstatus1, String syPendingPolicyCounterChangeTime1,
			String syPendingPolicyCounterstatus2, String syPendingPolicyCounterChangeTime2,
			String syPendingPolicyCounterstatus3, String syPendingPolicyCounterChangeTime3, String syResultCode,
			String qCI, String clientlessOptimizationRule, String contentFilteringRule, String fUP,
			String hTTPEnrichmentRule, String bMIIMEI, String bMIIMSI, String operatorID, String bMIRoamingStatus,
			String serviceExtendedAttribute3, String quotaExtendedAttribute, String transfer, String visitServiceZone11,
			String visitServiceZone12, String visitServiceZone13, String visitServiceZone14, String visitServiceZone15,
			String visitServiceZone16, String visitServiceZone17, String visitServiceZone18, String visitServiceZone19,
			String visitServiceZone20, String actualQuotaUsage, String rateDiscount, String actualAccountUsage,
			String usrStatus, String serviceUsageState, String reserved, String reserved1, String reserved2,
			String serviceExtendedAttribute1, String serviceExtendedAttribute2, String netLocAccessSupport,
			String transactionId, String quotaSequenceId, String oldQuotaValue, String quotaExpiredTime,
			String oldQuotaExpiredTime, String oldQuotaSequenceId, String ifrsParam) {
		super();
