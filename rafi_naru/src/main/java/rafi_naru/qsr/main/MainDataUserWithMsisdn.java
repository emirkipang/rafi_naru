 ...
 *
 */
public class MainDataUserWithMsisdn {
...
//				.reduceGroup(new OutputAggGroupReducer());
		...
		// Put into tuples
		output = outputAgg_all_distinct.flatMap(new OutputFlatMapWithMsisdn(Constant.DATAUSER_HEADER));
	}
	...
	public static void main(String[] args) throws Exception {
		...
		MainDataUserWithMsisdn main = new MainDataUserWithMsisdn(proses_paralel, sink_paralel, output);
